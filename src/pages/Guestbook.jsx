  ...
  return (
    <>
      <SEO 
        ...
        keywords="guestbook, komentar, portofolio, web developer, bali"
      />
        ...
        <main className="pt-24 pb-12 relative">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl font-bold text-center text-galaxy-text mb-4">Guestbook</h1>
              <p className="text-galaxy-muted text-center mb-12">Tinggalkan pesan atau komentar Anda.</p>
            </motion.div>
