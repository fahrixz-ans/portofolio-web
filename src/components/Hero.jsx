...
function SocialIcon({ name }) {
  ...
  <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.216h-3.118v12.33a2.89 2.89 0 1 1-2.89-2.89c.285 0 .56.041.822.118V8.865a6.01 6.01 0 0 0-.822-.057A6.008 6.008 0 1 0 15.82 14.82V8.542a7.902 7.902 0 0 0 4.769 1.601V6.686z"/>
    ...
    saweria : ( 
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  <path d="M12 2l2.2 4.45L19 7.2l-3.5 3.42.83 4.83L12 13.3l-4.33 2.15.83-4.83L5 7.2l4.8-.75L12 2zm-8 15h6c.55 0 1 .45 1 1s-.45 1-1 1H4v-2zm8 0h5.5c1.38 0 2.5 1.12 2.5 2.5S18.88 22 17.5 22H10v-2h7.5a.5.5 0 0 0 0-1H12v-2z"/>
</svg>
      ),
    linkedin: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
